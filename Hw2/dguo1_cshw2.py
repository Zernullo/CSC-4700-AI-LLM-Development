...
This program uses OpenAI's GPT-5-nano and OpenRouter's Qwen3-8b models to
answer questions from the SQuAD dataset. It demonstrates how to interact
with different LLM APIs, handle batch processing, and save the results in
JSON format.
