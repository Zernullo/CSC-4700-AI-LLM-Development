...
What this does:
	Provides a reusable prompt template for retrieval-augmented generation
	(RAG), instructing the model to answer strictly from supplied context.

What you'll learn:
	- How to constrain answers to retrieved context
	- How to handle missing answers safely
"""
